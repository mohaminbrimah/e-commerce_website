        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-3 cart-item" data-id="<?= (int)$item['id'] ?>">
                <div class="card-body d-flex gap-3 align-items-center">
                    <img src="<?= url(productImagePath($item['image'] ?? null, $item['slug'] ?? null)) ?>" width="80" height="80" class="rounded object-fit-cover" alt="<?= e($item['name']) ?>">
            ...
            <div class="card border-0 shadow-sm mb-2 opacity-75 saved-item" data-id="<?= (int)$item['id'] ?>">
                <div class="card-body d-flex gap-3 align-items-center py-2">
                    <img src="<?= url(productImagePath($item['image'] ?? null, $item['slug'] ?? null)) ?>" width="60" height="60" class="rounded object-fit-cover" alt="<?= e($item['name']) ?>">
